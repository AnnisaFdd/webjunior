                          ...
                          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0.5">
                            ...
                            <tbody>
                              ...
                              <tr style="font-size: 12px; text-align:center;">
                                ...
                                <td class="center">
                                  <?php echo anchor('admin/dashboard/edit/'.$mhs->id_mahasiswa, '<div class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></div>'); ?>
                                   <?php $onclick = array('onclick'=>"return confirm('Anda yakin hapus data?')");?>
                                  <?php echo anchor('admin/dashboard/hapus/'.$mhs->id_mahasiswa, '<div class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></div>',$onclick); ?>
                                </td>
                              </tr>  
                            <?php endforeach; ?>
                            </tbody>
